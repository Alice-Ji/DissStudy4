/*
==========================================================
Study 4 — Authentic comment injection
==========================================================
...
function injectStudyComments(posts, enteredUsername) {
  ...
  addCommentPair(
    ...
    "❤️ wow thank you, I loved this look too"
  );
  ...
  addCommentPair(
    ...
    "😭 stoppp this made me laugh, thank you"
  );
  ...
  addCommentPair(
    ...
    "😭 thank you, I really loved this one"
  );
  ...
  addCommentPair(
    ...
    "💫 thank you!! I wanted it to feel a little different"
  );
  ...
  addCommentPair(
    ...
    "🎬 ahh I love that, that was the goal"
  );
  ...
  addCommentPair(
    ...
    "❤️ wow thank you, I’m really proud of this one"
  );
  ...
  addCommentPair(
    ...
    "📷 thank you!! I had fun playing with them"
  );
  ...
  addCommentPair(
    ...
    "❤️ ahh thank you, I was so happy with these photos"
  );
