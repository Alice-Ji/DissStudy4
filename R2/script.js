...
function renderFeed() {
  ...
  injectStudyComments(posts, username); // Inject comments
  ...
  posts.forEach((post, index) => {
    ...
    <div id="comment-input-container-${index}"
         class="comment-input-container hidden">
        <input
            type="text"
